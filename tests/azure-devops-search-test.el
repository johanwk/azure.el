    ...
    (cl-letf (((symbol-function 'azure-post)
               (lambda (url _success &optional data _params _headers _error)
                 (setq captured-url url
                       captured-data data))))
      (azure-devops-work-item-create "User Story" "New story")
